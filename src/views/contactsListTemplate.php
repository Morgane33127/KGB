<tr class="table-secondary" id="co-ligne<?php echo $i; ?>">
    ...
    <td><?php echo $img; ?></td>
    <td><button type="submit" class="btn btn-danger" id="supp_ct_<?php echo $i; ?>" name="supp_ct_<?php echo $i; ?>">Supprimer</button></td>
</tr>